...
get_athena_query_response <- function(sql_query, return_athena_types=FALSE){
  ...
  response <- get_athena_query_response(sql_query=sql_query, return_athena_types=return_athena_types)
  return(response)
}
